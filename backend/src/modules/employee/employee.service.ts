...
class EmployeeService {
    ...
    async list(
        ...
        if (error) {
            logger.warn('Failed to list employees with full details (likely schema mismatch or join error)', error);
            ...
            try {
                ...
                if (fallbackResult.error) {
                    ...
                    // Last resort: return empty list to prevent 500 error
                ...
                logger.error('Critical error in employee list fallback', fallbackError);
                return { employees: [], total: 0 };
            }
        }
